...
SRC_URI = "git://github.com/KhronosGroup/SPIRV-Tools;protocol=http;branch=main;name=spirv-tools \
           git://github.com/KhronosGroup/SPIRV-Headers;name=spirv-headers;branch=main;destsuffix=${SPIRV_HEADERS_LOCATION} \
